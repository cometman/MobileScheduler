...
public class WidgetMapImpl extends com.vaadin.terminal.gwt.client.WidgetMap {
  public Class<? extends Paintable> getImplementationByServerSideClassName(String fullyQualifiedName) {
    ...
    if ( fullyQualifiedName == "com.vaadin.ui.NativeSelect" ) { ensureInstantiator(com.vaadin.terminal.gwt.client.ui.VNativeSelect.class); return com.vaadin.terminal.gwt.client.ui.VNativeSelect.class;}
  ...
  if( classType == com.vaadin.terminal.gwt.client.ui.VNativeSelect.class) {ApplicationConfiguration.startWidgetLoading();
  GWT.runAsync( 
